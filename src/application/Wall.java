...
public class Wall {
    ...
    boolean collision(Box box) {
        ...
        if (x + image.getWidth() >= box.getX() && x + image.getWidth() <= box.getX() 
        		+ box.getImage().getWidth()
                && y + image.getHeight() >= box.getY()
                && y + image.getHeight() <= box.getY() + box.getImage().getHeight()) {
            return true;
        }
        // collision with point (x, y + image.height)
        else if (x >= box.getX() && x <= box.getX() + box.getImage().getWidth() && y 
        		+ image.getHeight() >= box.getY()
                && y + image.getHeight() <= box.getY() + box.getImage().getHeight()) {
            return true;
        }
        // collision with point (x + image.width, y)
        else if (x + image.getWidth() >= box.getX() && x + image.getWidth() <= box.getX() 
        		+ box.getImage().getWidth()
    ...
    boolean collision(Wall wall) {
        // collision with point (x + image.width, y + image.height)
        if (x + image.getWidth() >= wall.getX() && x + image.getWidth() <= wall.getX() 
        		+ wall.getImage().getWidth()
        ...
        // collision with point (x + image.width, y)
        else if (x + image.getWidth() >= wall.getX() && x + image.getWidth() <= wall.getX() 
        		+ wall.getImage().getWidth()
    ...
    boolean collision(Coin coin) {
        // collision with point (x + image.width, y + image.height)
        if (x + image.getWidth() >= coin.getX() && x + image.getWidth() <= coin.getX() 
        		+ coin.getImage().getWidth()
        ...
        // collision with point (x + image.width, y)
        else if (x + image.getWidth() >= coin.getX() && x + image.getWidth() <= coin.getX() 
        		+ coin.getImage().getWidth()
